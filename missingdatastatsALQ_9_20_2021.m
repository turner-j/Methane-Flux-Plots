...
missingNEE19 = sum(isnan(USALQ.NEE(year(USALQ.TIMESTAMP_END)==2019)));
NEE19 = sum(~isnan(USALQ.NEE_F(year(USALQ.TIMESTAMP_END)==2019)));
missingtotalNEE19 = (missingNEE19./length(USALQ.NEE_F(year(USALQ.TIMESTAMP_END)==2019)))*100;
totalNEE19 = (NEE19./length(USALQ.NEE_F(year(USALQ.TIMESTAMP_END)==2019)))*100;

missingNEE20 = sum(isnan(USALQ.NEE(year(USALQ.TIMESTAMP_END)==2020)));
NEE20 = sum(~isnan(USALQ.NEE_F(year(USALQ.TIMESTAMP_END)==2020)));
missingtotalNEE20 = (missingNEE20./length(USALQ.NEE_F(year(USALQ.TIMESTAMP_END)==2020)))*100;
totalNEE20 = (NEE20./length(USALQ.NEE_F(year(USALQ.TIMESTAMP_END)==2020)))*100;

mo = month(USALQ.TIMESTAMP_END);
missingNEE = sum(isnan(USALQ.NEE(ismember(mo,4:10))));
missingtotalNEEseason = (missingNEE./length(USALQ.NEE_F(ismember(mo,4:10))))*100;

missingNEE = sum(isnan(USALQ.NEE(~ismember(mo,4:10))));
missingtotalNEEoffseason  = (missingNEE./length(USALQ.NEE_F(~ismember(mo,4:10))))*100;
